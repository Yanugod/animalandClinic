    ...
    <section id="about" class="hero__about">
        ...
        <div class="hero__about-texts">
            ...
            <div class="hero__about-paragraph">
                ...
                <br>
                <p>It arises from the need for the massive number of animals infected with bacteria at that time, there
                    were few clinics that had a particular veterinarian, so the former minister decided to form a
                    veterinarian in the center of Hudson, which was soon growing and expanding to what it is today.</p>
                <br>
                <p>Dr. Rogers Claudelle Johnson is always looking for ways to improve the quality of the service offered
                    by the company, innovate and update what we need and is there to solve any precarious situation that
                    an animal suffers. </p>
            </div>
        </div>
    </section>
